...
export class SocketManagementUseCases {
	constructor(
		@Inject()
		private readonly proxyAbonentRepository: ProxyAbonentRepository,
		@Inject()
		private readonly socketManagerAbstract: SocketManagerAbstract,
		@Inject()
		private readonly AIGAEAStrategy: AIGAEAStrategy,
	) {}
	...
	stopSocket(
		...
		return this.socketManagerAbstract.handleStop(
			dto.proxyToAbonentProjectId,
		);
	}
}
